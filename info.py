...
BOT_TOKEN = environ.get('BOT_TOKEN', "7223258247:AAG5nOdgT4lNoDdFldojd7qvrPIj6FNKn4E")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002410408277').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002607004114') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://masoomjaat860:yuEerrLKRW6TyA5q@cluster0.v5lkg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "masoomjaat860")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MRxVoltzSupport') # Support Chat Link Without https:// or @
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://mrxvoltz.koyeb.app/")
