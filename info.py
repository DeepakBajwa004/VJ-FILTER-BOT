...
auth_channel = environ.get('AUTH_CHANNEL', '-1002194487459 -1002464323606') # give your force subscribe channel id here else leave it blank
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://nuclear-miran-mrxbajwa-8f102eb6.koyeb.app/")
